...
#End Region
    ...
    Sub addQuestions(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        For i As Integer = 0 To dataArr.Length / 6 - 1
            If dataArr(baoMi.shiJuan, i) = iShiJuan Then
        ...
        For i As Integer = 0 To questionsCount - 1
            ...
            Select Case dataArr(baoMi.leiXing, CInt(ct.Tag))
    ...
    Private Sub btnTiJiao_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnTiJiao.Click
        ...
        For i As Integer = 0 To Me.questionsCount - 1
            ...
            iData = CInt(ct.Tag)
            Dim answerStr As String = dataArr(baoMi.answer, iData)  '标准答案
            Dim str As String = ""                                  '回答的答案

            Select Case dataArr(baoMi.leiXing, iData)
            ...
            Else
                deFenArr(dataArr(baoMi.leiXing, iData) - 1, 1) += 1
                ct.ForeColor = Color.Red
                If dataArr(baoMi.leiXing, iData) <> tiXing.jianDa Then
                    Dim lb As New Label

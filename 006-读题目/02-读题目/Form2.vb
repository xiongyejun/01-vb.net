...
Public Class Form2
    ...
    Private Sub Form2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            If System.IO.File.Exists(Application.StartupPath & shiZhi) Then
                ...
                iData = arr(3)
                Me.lbQuestion.Text = dataArr(0, iData) & "-" & dataArr(2, iData)
            End If
            tiShi()
    ...
    Private Sub btnNext_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNext.Click
        Try
            ...
            If Me.opRnd.Checked Then
                iData = Int(Rnd() * dataArr.Length / 6)
            Else
                If iData < dataArr.Length / 6 - 1 Then
                    iData += 1
                Else
                    iData = 0
                End If
    ...
    Private Sub btnAnswer_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAnswer.Click
        Try
            ...
            Me.lbAnswer.Text = dataArr(1, iData).ToString
            Me.btnNext.Focus()
        Catch ex As Exception
    ...
    Function tiShi()
        ...
        If dataArr(4, iData) = 1 Then
            str = str & "未标记。"
        Else
            str = str & "已标记。"
        End If

        str = str & "共有" & dataArr.Length / 6 & "个题目，当前第" & iData + 1 & "个。"
    ...
    Private Sub btnRemoveAllSign_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRemoveAllSign.Click, cmsRemoveAllSign.Click
        Try
            For i As Integer = 0 To dataArr.Length / 6 - 1

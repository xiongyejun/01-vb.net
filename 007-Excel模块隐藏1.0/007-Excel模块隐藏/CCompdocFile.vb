...
#Region "定义"
    ...
    Public file_byte() As Byte
    Public FileAddress As IntPtr   'file_byte的内存地址
...
#End Region
    ...
    Public Sub New(file_name As String)
        ...
        End If
    End Sub
    Overridable Function GetFileByte() As Integer
        Return 1
    End Function
    ...
    Private Function GetDir() As Integer
        ...
        Do
            ...
            'Dim str As String = System.Text.Encoding.Unicode.GetString(arr_dir(k).dir_name)
            'Debug.Print(Split(System.Text.Encoding.Unicode.GetString(arr_dir(k).dir_name), vbNullChar)(0))
            If Split(System.Text.Encoding.Unicode.GetString(arr_dir(k).dir_name), vbNullChar)(0) = "VBA" Then vba_index = k
            k = k + 1
            If k Mod 4 = 0 Then
                l_SID = arr_SAT(l_SID)
            End If
    ...
    Function GetModule() As Integer
        ...
        If Me.GetStream("PROJECT", arr_byte, stream_len, arr_address, if_short) = -1 Then
            Return -1
        End If
    ...
    Function ReWritePROJECT(ModuleName As String, Optional UnHide As Boolean = False, Optional UnProtectProject As Boolean = False)
        ...
        If UnHide Then
            Dim str_tmp As String = Left(str_PROJECT, 45)
            str_PROJECT = Replace(str_PROJECT, str_tmp, str_tmp & "Module=" & ModuleName & Chr(&HD) & Chr(&HA))
        ...
        For j As Integer = 0 To arr_dir.Length - 1
            ...
            If Split(Str, vbNullChar)(0) = "PROJECT" Then
                ReWriteFile(arr_byte_to_write, arr_address, step_address, n_size, arr_dir_address（j), arr_dir(j).stream_size)
                Exit For
            End If
        Next
    ...
    Overridable Sub ReWriteFile(ByRef arr_byte_to_write() As Byte, arr_address(,) As Integer, step_address As Integer, n_size As Integer, arr_dir_address_j As Integer, ByRef stream_size As Integer)
